...
public class DetailSubscriberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DetailSubscriberActivity.this, AjouActivite.class);
                Log.d("ADDACTIVITYFOR", "id:::" + subscriber.getId());
                intent.putExtra("subscriber_id", subscriber.getId());
    ...
    public class LoadSubcriber extends AsyncTask<Integer, Subscriber, Subscriber> {
        ...
        protected Subscriber doInBackground(Integer... id) {
            ...
            subscriber = new Dao(DetailSubscriberActivity.this).getSubscriber(id[0]);
            return subscriber;
        }
    ...
    public class LoadActivities extends AsyncTask<Integer, Subscriber, List<Activity>> {
        ...
        @Override
        protected List<Activity> doInBackground(Integer... integers) {
            Log.d("LOADACTIVITY", "subID:::" + subscriber_id);
            List<Activity> activities = new Dao(DetailSubscriberActivity.this).getListActivitys(subscriber_id);
            Log.d("lengthTabActivities", "" + activities.size());
            return activities;
        }
